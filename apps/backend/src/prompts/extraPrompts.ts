...
- **Physical Play:** Bondage, Impact Play, Spanking, Pegging, Orgasm Control / Denial, Ruined Orgasm, Edging, Chastity (Mental or Physical or Magical), Titfuck/Paizuri, Premature Ejaculation, Breath Play (Light), Blowjob, Thighjob, Handjob
- **Fetishes & Roles:** Feet Fetish, Pet Play, Light Masochism, Exhibitionism, Voyeurism, Cuckolding (Soft/Hard), Size Difference
- **Other:** Succubus Dynamics, Energy Vampirism (Mana Drain), Level draining
`;

export const CHARACTERS_TO_IGNORE = `
